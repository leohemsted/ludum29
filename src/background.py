...
class Background(Entity):
    def __init__(self, screen_dimensions):
        ...
        width = screen_dimensions[0] + 1 + math.ceil(screen_dimensions[0] / image_size[0]) * image_size[0]
        height = screen_dimensions[1] + 1 + math.ceil(screen_dimensions[1] / image_size[1]) * image_size[1]
